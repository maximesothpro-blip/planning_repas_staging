...
app.post('/api/accept-recipe', async (req, res) => {
  try {
    ...
    console.log('Full recipe data being sent to n8n:', JSON.stringify(recipeData));

    // Envoyer les données complètes au webhook n8n
    const dataToSend = {
      ...recipeData,
      timestamp: new Date().toISOString(),
      status: 'accepted'
    ...
    console.log('Complete payload to n8n:', JSON.stringify(dataToSend));
