...
// Endpoint pour envoyer un message au bot via n8n - DÉSACTIVÉ (chat-web non utilisé)
...
// Démarrer le serveur
app.listen(PORT, () => {
  console.log(`Backend STAGING server running on port ${PORT}`);
  console.log(`n8n Create Recipe: ${N8N_CREATE_RECIPE_WEBHOOK}`);
  console.log(`n8n Accept Recipe: ${N8N_ACCEPT_RECIPE_WEBHOOK}`);
  console.log(`n8n Modify Recipe: ${N8N_MODIFY_RECIPE_WEBHOOK}`);
